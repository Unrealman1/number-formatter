...
public class NumberFormatTest {
    ...
    public void testFormatLargeNumber() {
        ...
        assertEquals("один миллиард двести тридцать четыре миллиона пятьсот шестьдесят семь тысяч восемьсот " +
                        ...
                        "восемьсот девяносто миллиардов сто двадцать три миллиона четыреста пятьдесят шесть тысяч семьсот восемьдесят девять десятиквинтиллионных",
...
//        assertEquals("ноль целых одна миллиардная", numberFormatter.format("0.000000001"));
    ...
    public void testFraction() {
        ...
        String expected = "один миллиард двести тридцать четыре миллиона пятьсот шестьдесят семь тысяч восемьсот девяносто целых сто двадцать три миллиона четыреста пятьдесят шесть тысяч семьсот восемьдесят девять десятимиллионныхдвенадцать триллионов четыреста пятьдесят шесть миллиардов семьсот восемьдесят девять миллионов двенадцать тысяч триста сорок пять десятимиллиардных";
        String actual = numberFormatter.format(number);
        assertEquals(expected, actual);
    }
    ...
    public void testNegative() {
        String number = "-1234567890.12345678901234567890";
        String expected = "минус один миллиард двести тридцать четыре миллиона пятьсот шестьдесят семь тысяч восемьсот девяносто целых сто двадцать три миллиона четыреста пятьдесят шесть тысяч семьсот восемьдесят девять десятимиллионныхдвенадцать триллионов четыреста пятьдесят шесть миллиардов семьсот восемьдесят девять миллионов двенадцать тысяч триста сорок пять стомиллиардных";
        String actual = numberFormatter.format(number);
        assertEquals(expected, actual);
    }
    ...
    public void testFractionZero() {
        ...
        String expected = "один миллиард двести тридцать четыре миллиона пятьсот шестьдесят семь тысяч восемьсот девяносто";
        String actual = numberFormatter.format(number);
        assertEquals(expected, actual);
    }
    ...
    public void testFractionFour() {
        String expected = "один миллиард двести тридцать четыре миллиона пятьсот шестьдесят семь тысяч восемьсот девяносто целых одна тысяча двести тридцать четыре десятитысячных";
    ...
    public void testlowNumbers() {
        String[][] qas = {
                {"0.36312040047022176026",
                        "ноль целых тридцать шесть квинтиллионов триста двенадцать квадриллионов сорок триллионов сорок семь миллиардов двадцать два миллиона сто семьдесят шесть тысяч двадцать шесть стоквинтиллионных"},
                {"0.85882031235964539917",
                        "ноль целых восемьдесят пять квинтиллионов восемьсот восемьдесят два квадриллиона тридцать один триллион двести тридцать пять миллиардов девятьсот шестьдесят четыре миллиона пятьсот тридцать девять тысяч девятьсот семнадцать"},
                {"0.15644331981133396958",
                        "ноль целых пятнадцать квинтиллионов шестьсот сорок четыре квадриллиона триста тридцать один триллион девятьсот восемьдесят один миллиард сто тридцать три миллиона триста девяносто шесть тысяч девятьсот пятьдесят восемь"},
                {"0.12027167394518656351",
                        "ноль целых двенадцать квинтиллионов двадцать семь квадриллионов сто шестьдесят семь триллионов триста девяносто четыре миллиарда пятьсот восемнадцать миллионов шестьсот пятьдесят шесть тысяч триста пятьдесят одна"},
                {"0.34007673048821462913",
                        "ноль целых тридцать четыре квинтиллиона семь квадриллионов шестьсот семьдесят три триллиона сорок восемь миллиардов восемьсот двадцать один миллион четыреста шестьдесят две тысячи девятьсот тринадцать"},
                {"0.97670265464023864332",
                        "ноль целых девяносто семь квинтиллионов шестьсот семьдесят квадриллионов двести шестьдесят пять триллионов четыреста шестьдесят четыре миллиарда двадцать три миллиона восемьсот шестьдесят четыре тысячи триста тридцать две"},
                {"0.18897469220718310368",
                        "ноль целых восемнадцать квинтиллионов восемьсот девяносто семь квадриллионов четыреста шестьдесят девять триллионов двести двадцать миллиардов семьсот восемнадцать миллионов триста десять тысяч триста шестьдесят восемь"},
                {"0.78642141969434486981",
                        "ноль целых семьдесят восемь квинтиллионов шестьсот сорок два квадриллиона сто сорок один триллион девятьсот шестьдесят девять миллиардов четыреста тридцать четыре миллиона четыреста восемьдесят шесть тысяч девятьсот восемьдесят одна"},
                {"0.79755153745354312456",
                        "ноль целых семьдесят девять квинтиллионов семьсот пятьдесят пять квадриллионов сто пятьдесят три триллиона семьсот сорок пять миллиардов триста пятьдесят четыре миллиона триста двенадцать тысяч четыреста пятьдесят шесть"},
                {"0.37118415277531591201",
                        "ноль целых тридцать семь квинтиллионов сто восемнадцать квадриллионов четыреста пятнадцать триллионов двести семьдесят семь миллиардов пятьсот тридцать один миллион пятьсот девяносто одна тысяча двести одна"}
        };
        for (String[] qa : qas) {
    ...
    public void testPluralization() {
        ...
        assertEquals("один миллион одна тысяча одна целая один миллион одна тысяча одна десятимиллионная",
