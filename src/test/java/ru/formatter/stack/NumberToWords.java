...
public class NumberToWords implements NumberFormatter {
    ...
    static public final ScaleUnit[] SCALE_UNITS = new ScaleUnit[]{
            ...
            new ScaleUnit(24, "Септиллион", "quadrillion"),
            new ScaleUnit(21, "секстеллион", "trilliard"),
            new ScaleUnit(18, "квинтиллион", "trillion"),
            new ScaleUnit(15, "квадриллион", "billiard"),
            new ScaleUnit(12, "триллион", "billion"),
            new ScaleUnit(9, "миллиард", "milliard"),
            new ScaleUnit(6, "миллион", "million"),
            new ScaleUnit(3, "тысяча", "thousand"),
            new ScaleUnit(2, "сто", "hundred"),
